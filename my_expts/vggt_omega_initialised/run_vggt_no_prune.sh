...
OUTPUT_BASE_DIR="./my_expts/vggt_omega_initialised/output_full_5M_noPrune"

mkdir -p "${OUTPUT_BASE_DIR}"

for SCENE in "${SCENES[@]}"; do
    echo "=================================================="
    echo "Starting VGGT Training (NO PRUNING) for scene: ${SCENE}"
    echo "=================================================="
    if python train.py \
        ...
        --eval \
        --start_pruning 30000 \
        --wandb_name "vggt_5M_noPrune_${SCENE}"; then
