...
OUTPUT_BASE_DIR="./my_expts/vggt_omega_initialised/output_full_5M_noDensify"

mkdir -p "${OUTPUT_BASE_DIR}"

for SCENE in "${SCENES[@]}"; do
    echo "=================================================="
    echo "Starting VGGT Training (NO DENSIFICATION) for scene: ${SCENE}"
    echo "=================================================="
    if python train.py \
        ...
        --wandb_name "vggt_5M_noDensify_${SCENE}"; then
